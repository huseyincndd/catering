        ...
        {isMobileMenuOpen && (
          <>
            ...
            >
              ...
              <button
                onClick={() => setIsMobileMenuOpen(false)}
                className="absolute top-4 right-4 p-2 text-gray-900 hover:text-orange-500 transition-colors"
              ...
              <div className="p-8 pt-20">
                ...
                <motion.a
                  ...
                  className="block w-full px-6 py-3 bg-orange-500 text-white text-center font-semibold rounded-lg hover:bg-orange-600 transition-colors"
                >
                  Teklif Al
                </motion.a>
                ...
                >
                  <div className="flex items-center gap-4">
                    <a
                      href="https://www.instagram.com/catering"
                      target="_blank"
                    ...
                    <a
                      href="https://www.facebook.com/catering"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-600 hover:text-orange-500 transition-colors"
                    >
